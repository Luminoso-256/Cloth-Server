...
public class PlayerData {
    ...
    public void setLastDeathLocation(Double deathX, Double deathY, Double deathZ, Float deathLookYaw, Float deathLookPitch) {
        this.lastDeathLocation.setName("Last Death Location");
        this.lastDeathLocation.setLocationVector(deathX, deathY, deathZ);
        this.lastDeathLocation.setLookVector(deathLookYaw, deathLookPitch);
    }

    // Check if a player has failed harcore
    public boolean hasFailedHardcore() {
        return this.hasFailedHardcore;
    }

    // set if a player has failed the hardcore challenge or not
    public void setHasFailedHardcore(boolean failState) {
        this.hasFailedHardcore = failState;
    }
    ...
    public void resetBackUsages() {
        backuses = 0;
    }

    public HashMap<Integer, Integer> getPlayerServerInventory() {
        return playerServerInventory;
    }
