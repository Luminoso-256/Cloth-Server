...
public class AxisAlignedBB
{
    ...
    public AxisAlignedBB expands(double d, double d1, double d2)
    {
        double d3 = minX - d;
        double d4 = minY - d1;
        double d5 = minZ - d2;
    ...
    public double func_710_a(AxisAlignedBB axisalignedbb, double d)
    {
    ...
    public double func_701_b(AxisAlignedBB axisalignedbb, double d)
    {
    ...
    public double func_709_c(AxisAlignedBB axisalignedbb, double d)
    {
        if(axisalignedbb.maxX <= minX || axisalignedbb.minX >= maxX)
        {
            return d;
    ...
    public AxisAlignedBB func_694_e(double d, double d1, double d2)
    {
        double d3 = minX;
        double d4 = minY;
        double d5 = minZ;
