...
public class MapGenCavesHell extends MapGenBase
{
    ...
    protected void func_4106_a(int i, int j, byte abyte0[], double d, double d1, 
            double d2)
    {
        func_4105_a(i, j, abyte0, d, d1, d2, 1.0F + field_946_b.nextFloat() * 6F, 0.0F, 0.0F, -1, -1, 0.5D);
    }

    protected void func_4105_a(int i, int j, byte abyte0[], double d, double d1, 
            ...
            double d3)
    {
        ...
        for(; k < l; k++)
        {
            ...
            if(!flag && k == j1 && f > 1.0F)
            {
                func_4105_a(i, j, abyte0, d, d1, d2, random.nextFloat() * 0.5F + 0.5F, f1 - 1.570796F, f2 / 3F, k, l, 1.0D);
                func_4105_a(i, j, abyte0, d, d1, d2, random.nextFloat() * 0.5F + 0.5F, f1 + 1.570796F, f2 / 3F, k, l, 1.0D);
                return;
            }
    ...
    {
        int i1 = field_946_b.nextInt(field_946_b.nextInt(field_946_b.nextInt(10) + 1) + 1);
